# Lab 11: Business Impact Analysis

**Course:** GRC103 - Risk Assessment & Management  
**Week:** 11  
**Duration:** 5 days  
**Level:** Intermediate  
**Prerequisites:** Week 10 - Risk Assessment Methodologies

## Lab Overview

This lab focuses on conducting business impact analysis (BIA) to identify critical business functions and determine recovery requirements. Participants will calculate RTOs and RPOs.
...
### Task 1: Business Function Identification (Day 1)

**Objective:** Identify and catalog critical business functions and dependencies

**Instructions:**

1. Create a working directory for this task:
   ```bash
   mkdir -p ~/grc-lab-week11/task1
   cd ~/grc-lab-week11/task1
   ```
...
3. Follow the step-by-step procedures below:
   ...
   **Step-by-Step Procedure:**
   ...
   # Task 1 - Business Function Identification
...
### Task 2: Impact Analysis and Quantification (Day 2)

**Objective:** Analyze and quantify business impacts of disruptions

**Instructions:**

1. Create a working directory for this task:
   ```bash
   mkdir -p ~/grc-lab-week11/task2
   cd ~/grc-lab-week11/task2
   ```
...
### Task 3: RTO and RPO Determination (Day 3)

**Objective:** Calculate and document RTO and RPO for critical systems

**Instructions:**

1. Create a working directory for this task:
   ```bash
   mkdir -p ~/grc-lab-week11/task3
   cd ~/grc-lab-week11/task3
   ```
...
3. Follow the step-by-step procedures below:
   ...
   **Step-by-Step Procedure:**
   ...
   # Task 3 - RTO and RPO Determination
...
### Task 4: Criticality Assessment (Day 4)

**Objective:** Assess and rank business function criticality

**Instructions:**

1. Create a working directory for this task:
   ```bash
   mkdir -p ~/grc-lab-week11/task4
   cd ~/grc-lab-week11/task4
   ```
...
### Task 5: BIA Report Development (Day 5)

**Objective:** Create comprehensive business impact analysis report

**Instructions:**

1. Create a working directory for this task:
   ```bash
   mkdir -p ~/grc-lab-week11/task5
   cd ~/grc-lab-week11/task5
   ```
